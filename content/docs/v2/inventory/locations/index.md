...
<div class="note">The calculation of the available space requires the correct volume of the location to be specified and that all of the stock in that location has a <a href="/docs/v3/inventory/stock-view/#volume-per-pack">volume recorded</a></div>
