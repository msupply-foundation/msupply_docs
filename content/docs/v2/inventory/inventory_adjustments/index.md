...
Inventory Adjustments can be made directly from the [Stock View](/docs/v3/inventory/stock-view/) without the need to create a full Stocktake.
...
![Stock View showing the Adjust Stock button](/docs/v3/inventory/stock-view/images/stock_adjust.png)

The **Stock Adjustment** dialog will open.

![Stock Adjustment dialog](/docs/v3/inventory/stock-view/images/stock_adjust_form.png)
...
<div class="note">
Backdating for inventory adjustments must be enabled by an administrator before the <strong>Date</strong> field appears. See <a href="/docs/v3/manage/global-preferences/">Global Preferences</a> for configuration details.
</div>
...
Backdating for inventory adjustments is controlled by the **Backdating** global preference, available on the [Open mSupply Central Server](/docs/v3/getting-started/central-server).
...
See [Global Preferences](/docs/v3/manage/global-preferences/) for instructions on configuring these settings.
