...
L'importation et la suppression d'articles du catalogue d'équipements ne peuvent être effectuées que depuis le [Serveur Central Open mSupply](/docs/v3/getting-started/central-server).
...
<div class="note">Les raisons du journal de statut sont gérées depuis le <a href="/docs/v3/getting-started/central-server">serveur central Open mSupply</a>.</div>
