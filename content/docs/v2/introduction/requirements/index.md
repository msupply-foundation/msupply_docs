...
| :----------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Windows Client machine for use with server | 64 bit processor<br/>Windows 10<br/>4 Gb RAM, 300Mb of disk space                                                                                              | 64 bit processor<br/>Windows 11<br/>8 Gb RAM, 500Mb of disk space                                                                                                                                                                         |
...
| Windows server                             | 64 bit processor<br/>Windows 10 Pro or Win server 2019<br/>16 Gb RAM<br/>100 GB HDD/SDD volume with daily backups to an external volume                        | 64 bit processor<br/>Windows Server 2025+<br/>32 Gb RAM<br/>4 x HDD/SDD volumes, 3 configured as RAID1 or RAID5 with hot spare<br/>Daily backups to the fourth volume plus daily off-site backups<br/>Attached to a Smart UPS (see below) |
...
| Windows single user                        | 64 bit processor<br/>Windows 10<br/>8 Gb RAM<br/>1 GB HDD/SDD volume with daily backups to an external volume                                                  | 64 bit processor<br/>Windows 11<br/>16 Gb RAM<br/> 1 GB HDD/SDD volume with daily backups to an external volume                                                                                                                           |
...
- **Open mSupply Central** — the single, special Open mSupply site that all remote sites synchronise with. Required from v2.0.00 onwards. See [Open mSupply Central Server](/docs/v3/getting-started/central-server/).
