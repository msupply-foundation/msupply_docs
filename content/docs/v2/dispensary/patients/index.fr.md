...
S'il y a plus de données dans votre vue Patient, c'est probablement parce que les Programmes Patient sont configurés. Vous pouvez en savoir plus dans la documentation [Programmes Patient](/docs/v3/programs/program-module).
