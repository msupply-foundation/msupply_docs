...
![Dispensary navigation menu showing Clinicians option](/docs/v3/dispensary/images/clinicians_dispensary_menu.png)

You will be presented with a list of clinicians visible to your store.

### Clinicians List

![Clinicians list view showing columns for Code, First name, Last name, Initials, Mobile, and Gender](/docs/v3/dispensary/images/clinicians-list-view.png)
...
You will need the permission [Can Add Clinicians](/docs/v3/settings/permissions/) to be able to add a new clinician.

Currently, clinicians can only be created from a prescription - either while creating a <a href="/docs/v3/dispensary/dispensing/#creating-a-dispensing-record">new dispensing record</a> or editing an <a href="/docs/v3/dispensary/dispensing/#changing-the-clinician">existing one.</a> They can also be created from a <a href="/docs/v3/dispensary/prescriptions/#creating-a-prescription">prescription</a>.
