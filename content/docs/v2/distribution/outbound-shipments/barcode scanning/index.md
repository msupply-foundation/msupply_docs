...
<div class="tip">USB scanner hardware needs to be detected once before it can be used. This is done from <strong>Admin &gt; Settings &gt; Barcode Scanners</strong>. See <a href="/docs/v3/settings/devices/#barcode-scanners">Devices settings</a> for how to detect and connect a scanner.</div>
