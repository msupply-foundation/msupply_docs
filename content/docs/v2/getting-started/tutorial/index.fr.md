...
![login!](images/log_in_error_fr.png)
...
![Inbound tabs](images/stock_receive_shortcut.fr.png)
...
Utilisez la page [Aide](/docs/v3/help/help) pour accéder au guide d'utilisation d'Open mSupply (où vous vous trouvez actuellement !). La page Aide vous permet également de nous faire part de vos commentaires ou de nous envoyer vos demandes d'assistance.
