...
Utilice la página [Ayuda](/docs/v3/help/help) para acceder a la Guía del usuario de Open mSupply (¡donde se encuentra ahora mismo!). La página de Ayuda también le permite ponerse en contacto con nosotros para enviarnos sus comentarios o solicitudes de asistencia.
