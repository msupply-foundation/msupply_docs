...
<div class="note">
Enabling and disabling reports is an administrator task. Which users can manage reports is controlled by their <a href="/docs/v3/settings/permissions/">permissions</a>.
</div>
