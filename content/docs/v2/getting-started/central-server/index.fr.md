...
- Tous les sites distants Open mSupply faisant partie du [système de synchronisation](/docs/v3/sync/synchronisation/) communiqueront avec le serveur central Open mSupply.
