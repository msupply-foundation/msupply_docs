...
You can manage Patients by programs in Open mSupply. This involves some special settings. Please see [Patients](/docs/v3/dispensary/patients) for more information on how to view and create patients.
...
Clicking on a program will take you to the patient's program enrolment details. See [Program Enrolment](/docs/v3/programs/program-module/#program) for more information.
...
Clicking on an encounter will take you to the encounter details. See [Encounter](/docs/v3/programs/program-module/#encounter) for more information.
...
Clicking on a contact will take you to the contact details. See [Contact Tracing](/docs/v3/programs/program-module/#contact-tracing) for more information.
...
Clicking on an Immunization Program will take you to the patient's Vaccination Card for that program. See [Vaccination Cards](/docs/v3/programs/program-module/#vaccination-cards) for more information.
...
If a vaccine item and batch were selected, the system will automatically create and finalise a [Prescription](/docs/v3/dispensary/dispensing). Prescriptions are created for each vaccination record to track stock usage.
...
- If you change from `Given` to `Not given`, and a Prescription was previously created from the vaccination, you will have the option to `revert the existing stock transaction`
  - If enabled, a [Customer Return](/docs/v3/distribution/customer-returns) will be created for the vaccine item that was previously administered (note that the prescription will continue to exist - finalised prescriptions cannot be deleted)
...
- If you change the item or batch, and a Prescription was previously created from the vaccination, you will have the option to `update stock transactions`. If enabled:
  - A [Customer Return](/docs/v3/distribution/customer-returns) will be created for the vaccine item that was previously administered
  - A [Prescription](/docs/v3/dispensary/dispensing) will be created for the new vaccine item/batch
