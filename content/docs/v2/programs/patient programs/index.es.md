...
Puedes gestionar pacientes por programas en Open mSupply. Esto implica algunas configuraciones especiales. Consulta la sección de [Pacientes](/docs/v3/dispensary/patients) para obtener más información sobre cómo ver y crear pacientes.
...
Hacer clic en un programa llevará a los detalles de la inscripción del paciente en ese programa. Consulta [Inscripción en Programas](/docs/v3/programs/program-module/#program) para más información.
...
Hacer clic en un encuentro llevará a los detalles de dicho encuentro. Consulta [Encuentros](/docs/v3/programs/program-module/#encounter) para más información.
...
Hacer clic en un contacto llevará a los detalles de dicho contacto. Consulta [Rastreo de Contactos](/docs/v3/programs/program-module/#contact-tracing) para más información
...
Hacer clic en un Programa de Inmunización llevará a la Tarjeta de Vacunación del paciente para ese programa. Consulta [Tarjetas de Vacunación](/docs/v3/programs/program-module/#vaccination-cards) para más información.
...
Si se seleccionaron un ítem y un lote de vacuna, el sistema creará y finalizará automáticamente una [Prescripción](/docs/v3/dispensary/dispensing). Las prescripciones se generan para cada registro de vacunación con el fin de rastrear el uso de inventario.
...
- Si cambias de `Administrada` a `No administrada`, y anteriormente se creó una prescripción a partir de la vacunación, tendrás la opción de `revertir la transacción de stock existente`
  - Si se habilita, se creará una [Devolución de Cliente](/docs/v3/distribution/customer-returns) para el ítem de vacuna que fue administrado previamente (ten en cuenta que la prescripción continuará existiendo, ya que las prescripciones finalizadas no pueden eliminarse).
...
- Si cambias el ítem o lote, y anteriormente se creó una prescripción a partir de la vacunación, tendrás la opción de ` actualizar las transacciones de stock`. Si se habilita:
  - Una [Devolución de Cliente](/docs/v3/distribution/customer-returns) para el ítem de vacuna que fue administrado previamente
  - Una [Prescripción](/docs/v3/dispensary/dispensing) para el nuevo ítem/lote de vacuna
