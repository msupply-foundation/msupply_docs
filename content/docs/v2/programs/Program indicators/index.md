...
1. Create a [program Internal
   Order](/docs/v3/programs/requisitions/#creating-a-program-internal-order).
...
1. Create a manual requisition to another store as described [here](/docs/v3/distribution/requisitions/#manual-requisition)
2. Click on the Indicators tab
