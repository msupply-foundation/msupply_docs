...
Para a imunização [Programas de doentes](/docs/v3/programs/program-module), contacte o seu administrador para fazer a configuração.

Depois de o Programa de Imunização base ser criado, pode ser ainda mais configurado no <a href='/docs/v3/getting-started/central-server'>Open mSupply Central Server<a>. Consulte a secção <a href="#permissions-restrictions">Permissões e restrições</a> para mais detalhes.
...
| **Etiqueta**                      | O rótulo da dose, a apresentar no [Cartão de Vacinação](/docs/v3/programs/program-module#vaccination-cards)                                                       |
...
Os programas de imunização só podem ser geridos no [Open mSupply Central Server](/docs/v3/getting-started/central-server) e requerem a preferência de loja [`mobile: Usa o módulo de vacinas`](https://docs.msupply.org.nz/cold_chain_equipment:mobile?s[]=vaccine#enable_the_vaccine_module_for_the_mobile_store).
