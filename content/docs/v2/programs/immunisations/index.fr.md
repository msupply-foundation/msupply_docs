...
Remarque : Les programmes vaccins ne sont visibles que sur le [Serveur Central Open mSupply](/docs/v3/getting-started/central-server).
...
Les programmes de vaccination ne sont visibles que sur le [Serveur Central Open mSupply](/docs/v3/getting-started/central-server) et nécessite la préférence du dépot [`mobile: Uses vaccine module`](https://docs.msupply.org.nz/cold_chain_equipment:mobile?s[]=vaccine#enable_the_vaccine_module_for_the_mobile_store).
