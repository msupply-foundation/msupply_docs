...
For Immunization [Patient Programs](/docs/v3/programs/program-module), contact your administrator to get set up.

Once the base Immunization Program is created, it can be further configured in the [Open mSupply Central Server](/docs/v3/getting-started/central-server). See the <a href="#permissions-restrictions">Permissions & Restrictions</a> section for more details.
...
| **Label**               | The label of the dose, to appear in the [Vaccination Card](/docs/v3/programs/program-module#vaccination-cards)              |
...
Immunization Programs can only be managed on the [Open mSupply Central Server](/docs/v3/getting-started/central-server) and requires the [`mobile: Uses vaccine module`](https://docs.msupply.org.nz/cold_chain_equipment:mobile?s[]=vaccine#enable_the_vaccine_module_for_the_mobile_store) store preference.
