...
La lista de instalaciones está disponible únicamente en el [Servidor Central de Open mSupply](/docs/v3/getting-started/central-server). Aquí puedes ver todos los almacenes y gestionar sus propiedades.
...
![Pagination: showing](/docs/v3/images/list_showing.png)
...
![Pagination: navigating](/docs/v3/images/list_pagenumbers.png)
...
![Rows per page](/docs/v3/images/rows-per-page-select.png)
...
Los almacenes solo son visibles en el [Servidor Central de Open mSupply](/docs/v3/getting-started/central-server).
