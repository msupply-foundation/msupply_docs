...
| **Tampon de sécurité du stock (mois)**                                | <a href="/docs/v3/manage/facilities/#store-properties">Propriétés du dépôt</a>                                                                                                           | Prévisions de vaccins basées sur la population                                              |
| **Intervalle d'approvisionnement (mois)**                             | Propriétés du dépôt                                                                                                                                                                   | Prévisions de vaccins basées sur la population                                              |
| **Seuil en nombre de mois pour afficher les alertes de stock faible** | <a href="/docs/v3/manage/facilities/#store-preferences">Préférences du dépôt</a>                                                                                                         | Widget du tableau de bord : « Produits à risque de rupture de stock »                       |
...
Les seuils d'alerte du tableau de bord contrôlent quand les articles apparaissent dans les widgets d'alerte de stock du [tableau de bord](/docs/v3/getting-started/home/). Les deux valeurs sont mesurées en mois de stock et sont configurées dans les préférences du dépôt Open mSupply.

Pour configurer ces paramètres, accédez à `Options` > `Dépôts`, sélectionnez un dépôt et ajustez les préférences. Voir [Préférences du dépôt](/docs/v3/manage/facilities/#store-preferences) pour plus de détails.
...
Ces paramètres sont utilisés dans les prévisions de vaccins basées sur la population pour calculer les niveaux de stock cibles. Ils sont configurés comme propriétés du dépôt sur le serveur central Open mSupply. Voir [Propriétés du dépôt](/docs/v3/manage/facilities/#store-properties) pour les détails de configuration, et [Plugins](/docs/v3/plugins/general-plugins/) pour plus d'informations sur les prévisions basées sur la population.
...
Voir [Préférences du dépôt](/docs/v3/manage/facilities/#store-preferences) pour plus de détails.
...
Voir [Propriétés du dépôt](/docs/v3/manage/facilities/#store-properties) pour plus de détails.
