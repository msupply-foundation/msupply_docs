...
La gestion des données démographiques est uniquement disponible sur le [Serveur Central Open mSupply](/docs/v3/getting-started/central-server).
...
Les données démographiques ne sont visibles que sur le [Serveur Central Open mSupply](/docs/v3/getting-started/central-server) et nécessitent la préférence de dépôt [`mobile : Utilise le module vaccin`](https://docs.msupply.org.nz/cold_chain_equipment:mobile?s[]=vaccine#enable_the_vaccine_module_for_the_mobile_store).

![Préférence de dépôt mSupply Module Vaccin](images/vaccine_module.png)
