...
The Global preferences list is available only on the [Open mSupply Central Server](/docs/v3/getting-started/central-server). They are preferences which apply to all Open mSupply sites.
...
| **Show contact tracing**                                          | Enables the [Contact Tracing](/docs/v3/programs/program-module/#contact-tracing) feature for Patients                                                                                                                                                                                                                                                                                                                                                                                    |
