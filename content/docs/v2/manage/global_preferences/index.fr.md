...
La liste des préférences globales est disponible uniquement sur le [Serveur Central Open mSupply](/docs/v3/getting-started/central-server). Ce sont des préférences qui s'appliquent à tous les sites Open mSupply.
...
| **Afficher le suivi des contacts**                                          | Active la fonctionnalité [Suivi des contacts](/docs/v3/programs/program-module/#contact-tracing) pour les patients                                                                                                                                                                                                                                                                                                                                                                                                          |
