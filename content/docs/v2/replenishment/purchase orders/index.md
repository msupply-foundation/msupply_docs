...
In order to use purchase orders you need to have the [Use procurement functionality](/docs/v3/manage/facilities/#store-preferences) store preference enabled for your store.

![Store preference](images/po_store_pref.png)

### Authorise Purchase Orders

Authorisation is required if the [Global preference](/docs/v3/manage/global-preferences/) `Authorise Purchase Orders` is enabled.
