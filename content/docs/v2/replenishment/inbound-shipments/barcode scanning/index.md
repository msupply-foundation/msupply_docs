...
<div class="tip">Scanner hardware needs to be set up before you can use it. See <a href="/docs/v3/settings/devices/#barcode-scanners">Devices settings</a> for how to detect and connect a USB scanner, and the <a href="/docs/v3/distribution/outbound-shipments/barcode-scanning/">Outbound Shipment barcode scanning</a> page for how to use the Android camera and what GS1 barcodes look like.</div>
