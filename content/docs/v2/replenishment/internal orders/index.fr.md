...
<div class="tip">
Si vous utilisez des réquisitions de programme, des options de filtre supplémentaires peuvent être disponibles, comme le filtrage par type de commande. Cela est utile pour trouver rapidement des commandes d'urgence. Voir <a href="/docs/v3/programs/requisitions/">Réquisitions de Programme</a> pour plus de détails sur les commandes d'urgence.
</div>
...
Si vous avez activé la préférence globale [`Afficher les prévisions basées sur la population`](/docs/v3/manage/global-preferences/), vous verrez le calcul de prévision basé sur la population à la place.
...
<div class="note">Les prévisions basées sur la population pour les vaccins sont disponibles en tant que fonctionnalité intégrée. Pour l'activer, activez <a href="/docs/v3/manage/facilities/#available-preferences">Utiliser les prévisions basées sur la population</a>. Lorsqu'elle est activée, vous verrez une colonne supplémentaire <b>Stock cible (population)</b> indiquant la cible calculée en fonction de la population desservie par ce dépôt.</div>
...
Vous aurez besoin de la permission [Peut confirmer la Commande Interne comme Envoyée](/docs/v3/settings/permissions/) pour pouvoir envoyer une Commande Interne :
