...
Here's how the bar appears, shown at the top of the home page:
...
If you want to dismiss the notification bar - you'll need to acknowledge the breach. You can do this from the [breach list view](/docs/v3/coldchain/monitoring/#acknowledging-breaches)
