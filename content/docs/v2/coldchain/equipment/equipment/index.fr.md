...
| **Hors-catalogue**         | Désigne si l'actif a ete créé hors actif catalogue (voir [Catalogue > Assets](/docs/v3/catalogue/assets/)) |
...
Dans ce cas, référez-vous à la section [Scanners de code barre](/docs/v3/administration/devices/#barcode-scanners) de la documentatiom `Administrateur` et configurez un sacnner avant de continuer.
...
<div class="note">Vous pouvez imprimer une étiquette QR code pour un équipement. Voir la section <a href="/docs/v3/coldchain/equipment/#printing-a-qr-code">Imprimer un code QR</a> [pour plus de détails]</div>
...
Pour configurer une imprimante d'étiquette, référez-vous a la section [Impression d'étiquette](/docs/v3/administration/devices/#label-printing) des pages Administrateur.
