...
| **Fora do catálogo**   | Indica se o ativo não foi criado a partir de um artigo do catálogo (ver [Catálogo > Ativos](/docs/v3/catalogue/assets/)) |
...
Vá até a seção [Escáneres de códigos de barras](/docs/v3/settings/devices/#barcode-scanners) da documentação de `Configuração` e configure um scaner antes de continuar.
...
<div class="nota">Podes imprimir uma etiqueta com um código QR para um equipamento. Consulte a seção <a href="/docs/v3/coldchain/equipment/#printing-a-qr-code">Imprimir código QR</a> para mais detalhes</div>
...
Para configurar una impresora de etiquetas, consulte a seção [Impressão de etiquetas](/docs/v3/settings/devices/#label-printing) nas páginas de configuração.
