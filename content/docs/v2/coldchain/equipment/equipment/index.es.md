...
| **Fuera de catálogo**    | Indica si el activo no fue creado a partir de un artículo del catálogo (ver [Catálogo > Activos](/docs/v3/catalogue/assets/)) |
...
¡No te preocupes! Ve a la sección [Escáneres de códigos de barras](/docs/v3/settings/devices/#barcode-scanners) de la documentación de `Configuración` y configura un escáner antes de continuar.
...
<div class="nota">Puedes imprimir una etiqueta con un código QR para un equipo. Consulta la sección<a href="/docs/v3/coldchain/equipment/#printing-a-qr-code">Imprimir código QR</a> para más detalles</div>
...
Para configurar una impresora de etiquetas, consulta la sección [Impresión de etiquetas](/docs/v3/settings/devices/#label-printing) en las páginas de configuración.
