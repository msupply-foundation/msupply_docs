...
| **Non-catalogue**     | Designates if the asset was not created from a catalogue item (see [Catalogue > Assets](/docs/v3/catalogue/assets/)) |
...
| **Catalogue item code** | The [Asset Catalogue code](/docs/v3/catalogue/assets) - i.e. the kind of asset to be imported | E003/002                   | \*                             |
...
If you do, don't panic! Head over to the [Barcode Scanners](/docs/v3/settings/devices/#barcode-scanners) section of the `Settings` documentation and configure a scanner before continuing.
...
<div class="note">You can print a QR code label for an equipment item. See the <a href="/docs/v3/coldchain/equipment/#printing-a-qr-code">Print QR code</a> section for details</div>
...
To configure a label printer, refer to the [Label Printing](/docs/v3/settings/devices/#label-printing) section of the settings pages.
