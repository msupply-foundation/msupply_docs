...
- [Assess CCE capacity for the country](/docs/v3/coldchain/gaps/#assessing-cce-capacity)
- [Forecast the demand for CCE capacity over the next 5 years](/docs/v3/coldchain/gaps/#forecasting-demand-for-cce-capacity)
- [Compare the current CCE capacity to the forecast demand](/docs/v3/coldchain/gaps/#comparing-cce-capacity-to-forecast-demand)
- [Identify facilities that will need intervention due to increased demand](/docs/v3/coldchain/gaps/#identifying-facilities-that-need-intervention)
#### Compromised stock identification
...
Sensors can be linked to a stock storage [Location](/docs/v3/inventory/locations/). 
