...
<div class="note">The <code>Plugins</code> management screen is only available on the <a href="/docs/v3/getting-started/central-server/">Open mSupply Central Server</a>, and only to users who have the <code>Access server administration</code> permission (see the <a href="/docs/v3/settings/permissions/">Permissions</a> page).</div>
