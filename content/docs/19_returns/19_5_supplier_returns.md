...
Often, you will be returning goods that you received via an Inbound Shipment. In this case, you can [create a Supplier Return from the Inbound Shipment](/docs/19_returns/19-2-returnsinboundshipment/) itself.
