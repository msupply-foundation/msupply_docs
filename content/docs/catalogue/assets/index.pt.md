...
<div class="nota"> As razões do registo de estado são gerenciadas a partir do servidor central de Open mSupply. <a href="/docs/getting-started/central-server"> Clique aqui para obter mais informações </a>.</div>
