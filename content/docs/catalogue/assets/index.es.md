...
<div class="nota">Las razones del registro de estado se gestionan desde el servidor central de Open mSupply. <a href="/docs/getting-started/central-server">Haz clic aquí para obtener más información</a>.</div>
