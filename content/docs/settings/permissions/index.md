...
| Permissions (3)      | Admin                       | View log                                             | Able to view the logs, these show as a tab on many windows.<br/><strong style="color: #c97500">Note:</strong> Required for a user to perform a repack, as this uses log data. |
