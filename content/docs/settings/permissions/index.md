...
|                      | Names                       | Edit customer, supplier & manufacturer names         | Can edit customer and supplier properties; needs to be used in conjunction with `Open mSupply Central Server` permission                         |
