...
Choisissez `Gérer` > `Dépôts` dans le panneau de navigation.
...
| **Commander en paquets**                                                                          | Définit par défaut la représentation des Commandes Internes/Réquisitions en paquets plutôt qu'en unités                                                                                                             |
...
| **Gérer les vaccins en doses**                                                                    | Affiche les niveaux de stock et les transactions pour les vaccins en doses, plutôt qu'en unités ou paquets                                                                                                          |
...
| **Options de statut de facture**                                                                  | Configurer les statuts de facture disponibles pour les expéditions sortantes / retours clients, et les expéditions entrantes / retours fournisseurs.                                                                 |
