...
Les seuils d'alerte du tableau de bord contrôlent quand les articles apparaissent dans les widgets d'alerte de stock du [tableau de bord](/docs/getting-started/home/). Les deux valeurs sont mesurées en mois de stock et sont configurées dans les préférences du dépôt Open mSupply.
