...
Pour configurer les préférences globales, accédez à la page des préférences globales via le menu Gérer :
...
| **Empêcher les transferts depuis ce nombre de mois avant l'initialisation** | Lors de la migration d'anciens sites mSupply Desktop et mobile vers Open mSupply, cette préférence peut éviter la génération de centaines d'expéditions entrantes bloquées. Open mSupply ne créera pas d'expéditions entrantes au statut `Prélevé` correspondant aux expéditions sortantes des dépôts fournisseurs prélevées ce nombre de mois avant la date d'initialisation du site. De même, il ne créera pas de réquisitions clients pour les commandes internes finalisées ce nombre de mois avant l'initialisation. |
| **Autoriser la réception des marchandises**                                 | Si le processus de réception des marchandises inclut une étape d'autorisation                                                                                                                                                                                                                                                                                                                                                                                                                                   |
