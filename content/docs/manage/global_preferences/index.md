...
The Global preferences list is available only on the [Open mSupply Central Server](/docs/getting-started/central-server). They are preferences which apply to all Open mSupply sites.
