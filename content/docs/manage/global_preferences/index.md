...
| **Display population based forecasting**                          | Whether to show the population based forecasting calculation instead of the standard AMC calculation in internal orders. This will also show the target stock (population) field in internal orders.                                                                                                                                                                                                                                                                                  |
