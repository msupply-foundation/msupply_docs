+++
title = "Creating Manual Outbound Shipments"
...
## Creating a Manual Outbound Shipment
...
For another way to add items, if you are using the desktop client or android app, you can make use of [Barcode Scanning](/docs/18_issuinggoods/16-8-barcodescanning/) to add items.
...
Sometimes, stock sent via an Outbound Shipment will need to be returned. You can do this by creating a [Customer Return](/docs/19_returns/19-4-customer-returns/).
