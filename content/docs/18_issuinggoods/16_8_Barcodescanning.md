+++
title = "Barcode Scanning Outbound Shipments"
...
If using the Open mSupply Desktop or Android App, you have the option of scanning items in order to add them to the Outbound Shipment.
