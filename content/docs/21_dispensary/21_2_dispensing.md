...
**Dispensing prescriptions** involves providing patients with the medications or treatments prescribed by their healthcare providers. This process ensures that the correct medications are given in the right dosage and quantity, according to the patient's prescription.

To dispense prescriptions in Open mSupply, you will use `Prescriptions` in the `Dispensary` mode.
