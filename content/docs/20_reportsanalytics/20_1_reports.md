...
**Reports** in Open mSupply are structured documents that provide a snapshot of various aspects of your inventory and supply chain. This helps users track and monitor the performance of their operations offering insights into stock levels, order statuses, budgeting, and much more.

Reports in Open mSupply can either be pre-configured or customized to meet specific needs. They provide users with a way to view and analyze data efficiently, supporting decision-making processes and ensuring that inventory and supply chain operations run smoothly.
