...
Pour utiliser les prescriptions, assurez-vous que votre magasin est réglé sur `Dispensary` (voir l'article [magasins virtuels](https://docs.msupply.org.nz/other_stuff:virtual_stores#store_type) pour savoir comment procéder).
