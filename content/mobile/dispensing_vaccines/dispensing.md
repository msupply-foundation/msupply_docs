...
![Custom invoices button on Navigator](/mobile/images/dispensing_patients.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_search.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_look_up.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patients_name.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_no_match.png)

### Adding a new Patient

  * To create a new patient, tap the **New Patient** button.

![Custom invoices button on Navigator](/mobile/images/dispense_patient_new.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_save.png)

### Editing a patient's details

To edit a patient's details, tap the **edit** button at the end of the row for that patient. Easy!

![Custom invoices button on Navigator](/mobile/images/dispense_patient_edit.png)

### Viewing a patient's History

You can also view the history for a patient by tapping the **history** button.

![Custom invoices button on Navigator](/mobile/images/dispense_patient_view_history.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_prescribers.png)

As for patients, only when you've entered all the required fields you'll be able to save the record.

![Custom invoices button on Navigator](/mobile/images/dispense_patients_final.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_prescriber_search.png)

  * You’ll see a new window
  * Enter some or all of the prescriber's first name, last name and/or Registration code
  * Click **Search**

![Custom invoices button on Navigator](/mobile/images/dispense_prescriber_search2.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_prescriber_search3.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_no_info.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_to_patient.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_filter.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_adjust_quantity.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_patient_prescription_comment.png)

Tapping the **Complete** button will finalise the prescription. That means that it's locked- you can't edit it any more.

![Custom invoices button on Navigator](/mobile/images/dispensing_patient_finalize.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_payment.png)

The dropdown list under the "Payment" allows you to select the type of the payment. (Types are configured on the server).

![Custom invoices button on Navigator](/mobile/images/dispense_payment_dropdown.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_payment_credit.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_payment_repayment.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_insurance_drop_down.png)

When entering the payment details, if the patient has an insurance policy, you can select it from the drop-down list:

![Custom invoices button on Navigator](/mobile/images/dispense_insurance_drop_down2.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_insurance_add.png)
...
![Custom invoices button on Navigator](/mobile/images/dispense_insurance_final.png)
